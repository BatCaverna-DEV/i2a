<template>
  <BContainer class="py-5">
    <BRow class="g-5">
      <BCol lg="7">
        <p class="i2a-eyebrow mb-3">Participe</p>
        <h1 class="h2 fw-bold mb-3">Oportunidades no grupo</h1>
        <p class="fs-6 text-body-secondary mb-5" style="max-width: 62ch">
          O I2A recebe estudantes de graduação em iniciação científica, iniciação tecnológica,
          voluntariado e projetos de extensão. Não é preciso experiência prévia em pesquisa —
          o que pesa é interesse e constância.
        </p>
