<template>
  <div>
    <CabecalhoPagina
      eyebrow="Contato"
      titulo="Fale com o grupo"
      descricao="Dúvidas sobre os projetos, interesse em colaboração institucional ou vontade de participar da pesquisa — escreva, respondemos em alguns dias úteis."
    />
