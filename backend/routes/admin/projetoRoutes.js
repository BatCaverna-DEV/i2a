...
import { donoOuAdmin, bloquearOrientando } from '../../helpers/auth.js';
import {
  projetoSchema,
  projetoUpdateSchema,
...
// a listagem já vem filtrada pelo papel (ver escopoPorPapel no controller)
...
// equipe do projeto (tabela orientacacoes) — só o coordenador ou um admin
router.post(
  '/:id/equipe',
  bloquearOrientando,
  validate(vinculoPesquisadorSchema),
  controller.adicionarMembro
);
router.delete('/:id/equipe/:pesquisadorId', bloquearOrientando, controller.removerMembro);
